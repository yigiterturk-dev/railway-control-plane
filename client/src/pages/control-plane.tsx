  ...
  return (
    <SidebarProvider style={{ "--sidebar-width": "15.5rem" } as CSSProperties}>
      <Sidebar collapsible="offcanvas" className="border-r border-sidebar-border">
        ...
        <SidebarFooter className="border-t border-sidebar-border p-4"><a href="https://github.com/moriana55/railway-control-plane" target="_blank" rel="noreferrer" className="flex min-h-10 items-center gap-2 rounded-md px-2 text-xs text-muted-foreground outline-none hover:bg-sidebar-accent hover:text-sidebar-foreground focus-visible:ring-2 focus-visible:ring-sidebar-ring"><Github className="size-4" /> Source & decisions</a></SidebarFooter>
      </Sidebar>
